...
Rectangle {
    ...
    ColumnLayout {
        ...
        Text { Layout.alignment: Qt.AlignHCenter; text: "⚽  Matchday"; font.pixelSize: 12; font.bold: true; color: theme.textSecondary }
        Text { Layout.alignment: Qt.AlignHCenter; text: 'FCB  2 - 1  RMA'; font.pixelSize: 20; font.bold: true; font.family: 'monospace'; color: theme.textPrimary }
