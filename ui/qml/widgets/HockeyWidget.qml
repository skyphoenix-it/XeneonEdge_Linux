...
Rectangle {
    ...
    ColumnLayout {
        ...
        Text { Layout.alignment: Qt.AlignHCenter; text: "🏒  Hockey"; font.pixelSize: 12; font.bold: true; color: theme.textSecondary }
        Text { Layout.alignment: Qt.AlignHCenter; text: 'NYR  3 - 2  TOR'; font.pixelSize: 20; font.bold: true; font.family: 'monospace'; color: theme.textPrimary }
